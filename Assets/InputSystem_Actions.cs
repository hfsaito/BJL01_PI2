...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Observer"",
            ""id"": ""241faa75-29df-4f39-8446-80a0170238e0"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""c550e80e-3ddb-4192-bbf6-91589ac93b77"",
                ...
                },
                {
                    ""name"": ""Photo"",
                    ""type"": ""Button"",
                    ""id"": ""81e73e53-a2a2-482d-a26c-8701d72fae47"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""Zoom"",
                    ""type"": ""Button"",
                    ""id"": ""4dd14ea9-d077-4663-85fa-2ab3b251a1f6"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Continue"",
                    ""type"": ""Button"",
                    ""id"": ""7ef95e20-e6e1-43f1-a1f7-25e0cea74051"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""9b72f03c-010c-43f5-b76b-bc4ee0bd3911"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""87b965b7-dac3-4fd7-a9cc-17a45a7cb685"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c521107a-a94e-48d4-8d6c-02105045c880"",
                    ""path"": ""<Joystick>/stick"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Joystick"",
                ...
                {
                    ""name"": """",
                    ""id"": ""4891dd25-06d2-444c-a4e1-140a94993ee1"",
                ...
                {
                    ""name"": """",
                    ""id"": ""5454279d-8a19-4763-a90c-3999724f34fc"",
                ...
                {
                    ""name"": """",
                    ""id"": ""7e9192f4-81d8-46b2-a957-86ad6fd0f69d"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8f308bd9-522f-41a6-b576-f6b868c56c1a"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
    ...
    ""controlSchemes"": [
        ...
        m_Observer_Move = m_Observer.FindAction("Move", throwIfNotFound: true);
        m_Observer_Photo = m_Observer.FindAction("Photo", throwIfNotFound: true);
        m_Observer_Zoom = m_Observer.FindAction("Zoom", throwIfNotFound: true);
        m_Observer_Continue = m_Observer.FindAction("Continue", throwIfNotFound: true);
        // Player
    ...
    ~@InputSystem_Actions()
    {
        UnityEngine.Debug.Assert(!m_Observer.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Observer.Disable() has not been called.");
    ...
    private readonly InputAction m_Observer_Move;
    private readonly InputAction m_Observer_Photo;
    private readonly InputAction m_Observer_Zoom;
    private readonly InputAction m_Observer_Continue;
    /// <summary>
    /// Provides access to input actions defined in input action map "Observer".
    /// </summary>
    public struct ObserverActions
    {
        ...
        /// </summary>
        public ObserverActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Observer/Move".
        /// </summary>
        public InputAction @Move => m_Wrapper.m_Observer_Move;
        /// <summary>
        /// Provides access to the underlying input action "Observer/Photo".
        /// </summary>
        public InputAction @Photo => m_Wrapper.m_Observer_Photo;
        /// <summary>
        /// Provides access to the underlying input action "Observer/Zoom".
        /// </summary>
        public InputAction @Zoom => m_Wrapper.m_Observer_Zoom;
        /// <summary>
        /// Provides access to the underlying input action "Observer/Continue".
        /// </summary>
        public InputAction @Continue => m_Wrapper.m_Observer_Continue;
        /// <summary>
        ...
        /// <summary>
        /// Implicitly converts an <see ref="ObserverActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="ObserverActions.UnregisterCallbacks(IObserverActions)" />.
        /// </summary>
        /// <seealso cref="ObserverActions.UnregisterCallbacks(IObserverActions)" />
        ...
        /// </remarks>
        /// <seealso cref="ObserverActions.AddCallbacks(IObserverActions)" />
        /// <seealso cref="ObserverActions.RemoveCallbacks(IObserverActions)" />
        /// <seealso cref="ObserverActions.UnregisterCallbacks(IObserverActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="ObserverActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Observer" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="ObserverActions.AddCallbacks(IObserverActions)" />
    /// <seealso cref="ObserverActions.RemoveCallbacks(IObserverActions)" />
