...
## Legendas
> Essas são as frases que vão aparecer na tela com fundo escuro
1. Estes são os passos que os pernagens vão fazer

## Personagens
- `vítima` Rosiane Freitas
- `viúvo`
- `amante`
- `amiga`
...
> A polícia desiste das buscas.
> O `viúvo` providencia um funeral

> 20 de Maio de 1964
> A polícia acha um pano de seda contendo sangue em um copartimento de difícil acesso no carro
...
> A polícia chama `amiga` que conhecia bem a `vítima`
...
1. `viúvo` sai de casa
1. `viúvo` vai até a casa do `amante` e deixa uma faca com sague
1. `viúvo` volta para casa
